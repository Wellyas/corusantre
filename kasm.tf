module "kasmweb" {
  ...
  https_access_cidr   = ["176.161.232.174/32", "92.184.112.0/24", "176.149.95.90/32", "192.54.145.0/24", "192.54.200.0/24", "10.135.191.0/24","192.93.158.168/32","197.230.148.2/32"]
